...
encoded = Dense(40+24, activation='tanh',activity_regularizer=regularizers.l1(10e-6))(encoded )
decoded = Dense(40+16, activation='tanh',activity_regularizer=regularizers.l1(10e-6))(encoded)
decoded = Dense(40+8, activation='tanh',activity_regularizer=regularizers.l1(10e-6))(decoded)
...
autoencoder.fit(x={'imputation_input':x_train},y={'imputation_output':x_test,'classification_output':y_test},
                nb_epoch=epochs,batch_size=batch_size,shuffle=True,verbose=1,callbacks=[early_stopping],validation_split=0.2,
                )
