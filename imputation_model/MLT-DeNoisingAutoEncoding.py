...
df1=pd.read_csv(filepath_or_buffer='../data/training_setmissing_rate_0.1missing_features20.csv',encoding='utf-8')
df=df1
...
x = keras.layers.concatenate([decoded , classification_output])
imputation_output = Dense(40, activation='sigmoid',name='imputation_output')(x)
