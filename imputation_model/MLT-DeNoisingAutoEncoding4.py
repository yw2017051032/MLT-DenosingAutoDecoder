...
autoencoder.compile(loss={'imputation_output':'binary_crossentropy','classification_output':'binary_crossentropy'}, optimizer='adadelta',loss_weights={'imputation_output':0.7,'classification_output':0.3})
# autoencoder.summary()
