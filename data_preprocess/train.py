...
tf.flags.DEFINE_string("positive_data_file", "./data/rt-polarity/ert-polarity17012.pos", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/rt-polarity/ert-polarity17012.neg", "Data source for the negative data.")
